					...
					<div id="container">
                        ...
                        <?php
                            ...
                            if ($result != null && count($result->tour) > 0 ) {
                                ...
                                $tours = []; // initialize empty $tours array to avoid conflicts
                            }
                        ?>
                        ...
                        <?php foreach ($tours as $tour) { ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12" id="postsdasd-<?php print $tour->tour_id ?>" class="post-<?php print $tour->tour_id ?> tour type-tour status-publish hentry tag-inline product-type-day-tours location-<?php print strtolower($tour->location) ?>">
                                    <div class="card tour-desktop">
                                        <div class="tourcms-card-horizontal">

                                            <div class="tourcms-card-horizontal-pic">
                                                <div id="c-<?php print $tour->tour_id ?>-d" class="carousel slide" data-interval="false">
                                            ...
                                            <a href="<?php print $tour->tour_url_tracked; ?>"><span class="dummy"></span><span class="dummy-upper-right"></span></a>

                                            <div class="card-body">
                                                <div class="left">
                                                    <span class="tourcms-badge-tourtype-horizontal"><a href="https://wordpress.tourcms.com/tours-by-type/day-tours/" rel="tag">Day tours</a></span><span class="tourcms-badge-location-horizontal"> <a href="<?php print $tour->tour_url_tracked ?>" rel="tag"><?php print $tour->location ?></a></span>
                                                </div>
                                                <div class="right price-panel">
                                                    <p class="tourcms-card-text price-label" style="">Book now</p>
                                                    <p class="tourcms-card-text price"><span class='fromprice'>from <?php print $tour->from_price . " " . $tour->sale_currency ?></span></p>
                                                </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                                    <div class="card tour-mobile">
                                        ...
                                        <div id="c-<?php print $tour->tour_id ?>-m" class="carousel slide" data-interval="false">
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img class="d-block w-100" src="<?php print $tour->thumbnail_image ?>" alt="<?php print $tour->tour_name ?>">
                                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div style="margin-top:-0.8rem;"><span class="badge badge-location"> <a href="<?php print $tour->tour_url_tracked ?>" rel="tag"><?php print $tour->location ?></a></span><span class="badge badge-tourtype"><a href="https://wordpress.tourcms.com/tours-by-type/day-tours/" rel="tag">Day tours</a></span></div>
                                        ...
                                        <div class="card-footer bg-transparent">
                                            ...
                                            <p class="tourcms-card-text tour-mobile-footer-right" style=""><a href="<?php print $tour->book_url ?>">Book now <span class='fromprice'>from <?php print $tour->from_price . " " . $tour->sale_currency ?></span></a><br></p>
                                        </div>
